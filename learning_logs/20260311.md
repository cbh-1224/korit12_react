...
과제
공통 사항 :
npm create vite@4.4를 적용하여 프로젝트 생성 후 할 것
react / TS
shoppinglist를 참조하여 변형할 것
1. shoppinglist2
Item 자료형 내에 price: number;를 추가할 것.
TextField에 price를 나타내는 부분을 추가할 것.
secondary가 되면 primary에 product / secondary에 amount / secondary에 price로 표시하여
shoppinglist와 동일한 기능을 하도록 작성할 것.
2. todolist
MUI 적용해서 만들 것
이전에 JS 이용 방법과 달리 Dialog 컴포넌트를 활용하여 AddTodo 버튼을 눌렀을 때 모달창이 뜨도록 할 것.
나머지 자유 알아서 하시면 됩니다.